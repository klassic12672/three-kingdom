...
| SP-04 | [Characters, family, marriage, and succession](SP-04-characters-family-marriage-succession.md) | M2 | **Active — SP-04A exact-SHA hosted verified; SP-04B-L locally verified; hosted SP-04B-H and later packages pending** | SP-01, SP-02 |
