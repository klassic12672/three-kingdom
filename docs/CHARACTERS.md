...
The local Apple Silicon fixture constructs 1,000 characters with 250 proposals and 250 romance routes, then performs 1,000 aggregate record queries. Its final Release run measured 38.405 ms construction, 67.561 ms queries, and 191.298 ms for snapshot plus full-world checksum; checksum `6542e48b7ccdceee890fc757fd9104c6b4f73164ef4263b7b451947766777e06`. These are raw local correctness measurements without a wall-clock threshold. They do not satisfy or waive the full SP-04 three-second campaign-turn budget. Exact-SHA hosted macOS arm64/Windows x64 evidence remains pending, so D0 is not yet accepted and the full SP-04 criteria remain unchecked.
