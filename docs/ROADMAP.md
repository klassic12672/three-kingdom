...
30. Local candidate — SP-04G observer-filtered character/relationship/household/succession queries, minimum battle contribution mapping, registered wounds, and save schema 29 await exact-SHA hosted acceptance.

M0, M1, and SP-03 are complete. M2 remains Active and is not complete. SP-04 is Active: SP-04A through SP-04F9 have passing exact-SHA hosted macOS arm64/Windows x64 evidence at their accepted revisions, while SP-04G is an integrated local candidate. SP-05, SP-07, and SP-08 remain blocked. SP-04X1 is next only after G acceptance and is not started.
