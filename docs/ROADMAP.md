...
SP-04F8's neutral character-issued succession support has passing [exact-SHA hosted macOS arm64/Windows x64 evidence](evidence/SP-04F8-EXACT-SHA-c946c87.md) at `c946c8739d29e9f484bc921223e47cb5f24e38ab`. It adds exact declaration/replacement/withdrawal, one active record per ordered subject/supporter pair, 64/64 active capacities, 32 recent terminal records per subject with checked replaced/withdrawn folding, bounded authoritative queries, and no support strength, eligibility, precedence, selection, or downstream effect. Save schema 27 advances succession snapshot/system to v3 with an authenticated exact-F7 schema-26 migration and frozen fixture from `62e03b6e7d4a3965de4c97ed9b92e03b6d40fbe4`. Its 216 focused cases and zero-warning full Release gate pass 1,126 Simulation.Core, 73 Game.Content, 6 Game.Application, and 18 repository tests; both hosted platforms repeat the complete suite during native export/smoke. Full SP-04 acceptance and the three-second budget remain open.

SP-04F9's deterministic succession-death resolution has passing [exact-SHA hosted macOS arm64/Windows x64 evidence](evidence/SP-04F9-EXACT-SHA-d64ab31.md) at `d64ab315a96fda15a2802ebcc687bbf50924fa2c`. One exact reserved-system death workflow freezes explicit precedence over designation, typed descendants/adoption, principal spouse, typed collateral, claims, and support; selects, disputes, or records no successor; atomically composes existing death cleanup with personal-wealth and opaque-estate inheritance; records minimal distinct regency evidence; and transfers or explicitly ends/continues player control. Save schema 28 advances succession snapshot/system to v4 with one authenticated exact-F8 schema-27 migration. Its 307 focused cases and zero-warning full Release gate pass 1,217 Simulation.Core, 73 Game.Content, 6 Game.Application, and 18 repository tests; both hosted platforms repeat the complete suite during native export/smoke. The representative 1,000-character/100-resolution fixture is raw non-threshold evidence and does not establish the full-SP-04 three-second budget. Full SP-04 acceptance remains open.

SP-04G's observer-filtered application queries and minimum character-event integration have passing [exact-SHA hosted macOS arm64/Windows x64 evidence](evidence/SP-04G-EXACT-SHA-4bc88ae.md) at `4bc88aee38bda5cd67902fbb93f8386f5a87f380`. G adds one bounded surface for character, reused relationship, household, and succession views; live controlled-character continuity; one narrow three-type character battle-contribution adapter; and a registered wound action. It adds no final battle/tactical, political, faction, court, diplomacy, office, title, army, AI, content, or UI subsystem. Save schema 29 is vocabulary-only over the exact F9 schema-28 world shape and authenticates a frozen exact-F9 fixture before preserving its snapshot, checksum, diagnostics, pending command, resolution, continuity, and source bytes. Its 329-case focused slice and zero-warning full Release gate pass 1,239 Simulation.Core, 73 Game.Content, 18 Game.Application, and 18 repository tests; both hosted platforms repeat the complete suite during native export/smoke. SP-04/M2 remain Active and SP-05/SP-07/SP-08 remain blocked.
...
28. Complete — SP-04F8 neutral explicit succession support is accepted at exact SHA `c946c8739d29e9f484bc921223e47cb5f24e38ab` with hosted macOS arm64/Windows x64 evidence, without adding support strength, eligibility, precedence, selection, resolution, or downstream effects.
29. Complete — SP-04F9 deterministic succession resolution, inheritance, minimal regency hooks, and player continuity are accepted at exact SHA `d64ab315a96fda15a2802ebcc687bbf50924fa2c` with hosted macOS arm64/Windows x64 evidence and save schema 28.
30. Complete — SP-04G observer-filtered character/relationship/household/succession queries, minimum battle contribution mapping, registered wounds, and save schema 29 are accepted at exact SHA `4bc88aee38bda5cd67902fbb93f8386f5a87f380` with hosted macOS arm64/Windows x64 evidence.

M0, M1, and SP-03 are complete. M2 remains Active and is not complete. SP-04 is Active: SP-04A through SP-04G have passing exact-SHA hosted macOS arm64/Windows x64 evidence at their accepted revisions. SP-05, SP-07, and SP-08 remain blocked. SP-04X1 is next and is not started.
