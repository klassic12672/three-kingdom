...
SP-04D1's participant-issued political proposal/response/withdrawal, betrothal cancellation, adult fulfillment, deterministic causal-group retention, registered command/event, pending replay, and authenticated schema-10-to-11 package is locally verified. Exact-SHA hosted macOS arm64/Windows x64 acceptance remains pending. D1 adds no adult romance progression, household decision or movement, relationship consequence, lifecycle, succession, content, UI, AI, or platform behavior; the full SP-04 criteria and three-second turn budget remain unchecked.
...
10. Preserve the locally verified SP-04D1 political proposal/response/betrothal/union workflow, causal-group retention, and authenticated schema-10-to-11 compatibility package while exact-SHA hosted acceptance is collected.
11. After D1 exact-SHA acceptance, implement adult non-explicit romance progression as SP-04D2 without importing household decisions or coercion effects.

M0, M1, and SP-03 are complete. M2 remains Active and is not complete. SP-04 is Active: SP-04A, SP-04B-L, SP-04C0, SP-04C1, SP-04C2, SP-04C3, and SP-04D0 have passing exact-SHA hosted macOS arm64/Windows x64 evidence at their accepted revisions; D1 is locally verified with hosted acceptance pending. SP-05 remains blocked, and later SP-04 packages remain pending.
